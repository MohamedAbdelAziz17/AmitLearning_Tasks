...
extern void MCAL_TIMER2_WITH_INTERRUPT_Set_Delay(uint32_t Delay, uint8_t ocr, void (*ptr_to_func)(void));
/* Fast PWM */
...
extern void MCAL_TIMER2_STOP();
extern void MCAL_TIMER2_RESUME();
